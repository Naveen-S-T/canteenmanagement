...
void store::customerswitch()
{

}
void store::storepageswitch()
{
    system("CLS");    //clear screen in visual c++
    gotoxy(40,1);cout<<"GIT CANTEEN";
...
void store::price()
{
    ...
    cout<<"     ------------"<<endl;
    while(currprice>>item>>rate)      //Extracts a string from the input stream ie. currprice
    {
        cout<<"     "<<item<<" - "<<rate<<endl;
    }
    currprice.close();
    ...
    editprice<<"SNACKS"<<' '<<snackspr<<endl;     //writing to editprice ie. price.txt
...
void store::viewinvt()
{
    ...
    cout<<"     ITEM - PRICE"<<endl;
    cout<<"     ------------"<<endl;
    cout<<"     SNACKS   "<<snackspr<<endl;
    cout<<"     MAGGI   "<<maggipr<<endl;
    cout<<"     SOFT DRINKS "<<sdpr<<endl;
    ...
    cout<<"     ITEM - QUANTITY"<<endl;
    cout<<"     ---------------"<<endl;
    cout<<"     SNACKS   "<<snacksqty<<endl;
    cout<<"     MAGGI   "<<maggiqty<<endl;
    cout<<"     SOFT DRINKS "<<sdqty<<endl;
...
class billing
{
    public:
        ...
        void bill()
        {
            ...
            gotoxy(40,1);cout<<"GIT CANTEEN";
            gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
            cout<<"     BILL : PAY THE FOLLOWING AMOUNT IN CASH PLEASE"<<endl;
...
class login
{
  public:
      ...
      {
          system("CLS");
          gotoxy(40,1);cout<<"WELCOME TO GIT CANTEEN";
          gotoxy(40,2);cout<<"----------------------------"<<endl<<endl;
          cout<<"     1. LOGIN"<<endl;
...
void login::customerlogin()
{
    ...
    while(pass!=name)
    {
        ...
        if(pass==name)
        {
            cout<<endl<<"     CUSTOMER ACCESS GRANTED"<<endl;
            cout<<endl<<"     PRESS ANY KEY TO CONTINUE"<<endl;
            cout<<"     ";getch();
            cust();
        }
